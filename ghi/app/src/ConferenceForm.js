              ...
              <div className="offset-3 col-6">
                <div className="shadow p-4 mt-4">
                    ...
                    <div className="mb-3">
                        ...
                        <textarea value={this.state.description} onChange={this.handleDescriptionChange} className="form-control" name="description" id="description" rows="4"></textarea>
                    </div>
                    <div className="form-floating mb-3">
                    ...
                    <div className="mb-3">
                        <select value={this.state.id} onChange={this.handleLocationChange} required id="location" name="location" className="form-select">
